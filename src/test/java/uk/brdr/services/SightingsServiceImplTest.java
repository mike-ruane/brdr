...
public class SightingsServiceImplTest {
  ...
  void getSightingsForUser() {
    ...
    BigDecimal[] geo1 = {BigDecimal.valueOf(5324564, 5), BigDecimal.valueOf(-134567, 5)};
    BigDecimal[] geo2 = {BigDecimal.valueOf(5324565, 5), BigDecimal.valueOf(-134568, 5)};
    ...
    var expected =
        List.of(
            new SightingsByGeo(
                "Bath and North East Somerset", 8, List.of(geo1, geo2), List.of(23, 12, 5, 45)),
